...
const { NEXT_PUBLIC_INFURA_API_KEY, NEXT_PUBLIC_ETHERSCAN_API_KEY, NEXT_PUBLIC_POLYGONSCAN_API_KEY } = env
...
export function findNetworkKeyById(id: number): SupportedNetworks {
